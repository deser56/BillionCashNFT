...
const Discover = () => {
  ...
  return (
    <div className="pt-10" style={{ minHeight: '100vh' }}>
      <Head />
      <br />
      {
        isLoading ? <Preloader Title={"loading Top 4 "} /> : <section className="features section-padding-0-100" style={{ marginTop: '150px' }}>
          <div className="container ">
            <InfoComponent
              titleSm='Discover All New Items'
            />
