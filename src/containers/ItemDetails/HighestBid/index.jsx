      ...
      <div className="col-12 col-lg-3 mt-s">
          ...
          <div className="highest-bid bid-item">
              {data && data.map((item , i) => (
                <div key={i} className={`author-item ${item.addMargin && 'mb-0'}`}>
                    <div className="author-img ml-0" ><img className='author-back' src={item.img} width="40" alt=""/></div>
                    <div className="author-info">
                        <p>by<span className="w-text"> {item.text}</span></p>
                        <p>Bid at<span className="w-text"> {item.bid} BNB</span></p>
                    </div>
          ...
          <div className="highest-bid bid-item">
              <div className="author-item mb-0">
                  <div className="author-img ml-0"><img  className='author-back' src={authors1} width="40" alt="" /></div>
                  <div className="author-info">
                      <p>Listed by<span className="w-text"> Amillia Nnor</span></p>
                      <p>Price<span className="w-text mr-15"> 0.212 BNB</span><span><i className="fa fa-clock-o mr-5p"></i>01:36 AM</span></p>
                  </div>
